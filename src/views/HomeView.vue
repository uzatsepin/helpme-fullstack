...
<template>
    <main>
        <section
            class="container mx-auto mb-8 flex flex-col justify-between gap-6 sm:gap-10 md:mb-16 md:gap-16 lg:flex-row">
            <!-- content - start -->
        ...
        <section
            class=" container mx-auto flex flex-col items-center justify-between gap-10 border-t pt-8 lg:flex-row lg:gap-8">
            <!-- stats - start -->
            <div class="-mx-6 grid grid-cols-2 gap-4 md:-mx-8 md:flex md:divide-x">
                ...
                <div class="px-6 md:px-8">
                    <span class="block text-center text-lg font-bold text-indigo-500 md:text-left md:text-xl">{{
                        allUsers }}</span>
                    <span
                        class="block text-center text-sm font-semibold text-gray-800 md:text-left md:text-base">Користувачів</span>
                </div>

                <div class="px-6 md:px-8">
                    <span class="block text-center text-lg font-bold text-indigo-500 md:text-left md:text-xl">{{
                        usersStore.users.length }}</span>
                    <span class="block text-center text-sm font-semibold text-gray-800 md:text-left md:text-base">
                        Потребують допомоги
                    </span>
                </div>
